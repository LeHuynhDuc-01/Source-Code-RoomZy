...
public final class SpinnerItemBinding implements ViewBinding {
  ...
  private SpinnerItemBinding(@NonNull LinearLayout rootView, @NonNull CircleImageView imageView,
  ...
  public static SpinnerItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new SpinnerItemBinding((LinearLayout) rootView, imageView, textView);
    }
