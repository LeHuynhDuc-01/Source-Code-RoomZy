...
public final class CartLayoutBinding implements ViewBinding {
  ...
  private CartLayoutBinding(@NonNull RelativeLayout rootView, @NonNull ImageView likeBtn,
  ...
  public static CartLayoutBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new CartLayoutBinding((RelativeLayout) rootView, likeBtn, pDesc, pImage, pName, pPrice,
          shareBtn);
    }
